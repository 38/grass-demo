use crate::{ChromSet, WithChromSet, properties::Parsable, records::{Bed3, Bed4}};
...
pub trait LineRecordStreamExt : Read{
    fn into_record_iter<Record, S: ChromSet>(self, chrom_set: &S) -> LineRecordStream<S,Self, Record> where Self: Sized{
